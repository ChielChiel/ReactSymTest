        ...
        return (
            ...
            <Level.Side align="left">
                ...
                <Level.Item>
                    <Field kind="addons">
                        <Control>
                            <form onSubmit={(event) => {context.readSound()}}>
                                <Input placeholder="Find a post" type="text" value={zoekTerm} onChange={(event) => {setZoekTerm(event.target.value)}} />
                            </form>
                        </Control>
                        <Control>
                            <Button renderAs="button" color="primary" type="submit" onSubmit={(event) => {context.readSound()}}>Search</Button>
                        </Control>
